...
<div id="grid-container">
	<!-- linker deel grid -->
		<!-- Boven -->
			...
			<a href="<?php the_field('grid_link_1')?>" id="grid-left-top-middle" class="grid-box smallsquare hoverunderline" style="background-image: url(<?php the_field('grid_item_1')?>); background-size: contain">
			...
			<a href="<?php the_field('grid_link_2')?>" id="grid-left-top-right" class="grid-box smallsquare hoverunderline" style="background-image: url(<?php the_field('grid_item_2')?>); background-size: contain">
	...
	<div id="grid-right" class="grid-box largesquare">
		...
		<p class="grid-right-link title-flexbox">Explore</p>
			...
			<a href="<?php the_field('grid_link_3')?>" id="grid-left-bottom-left" class="grid-box smallsquare hoverunderline" style="background-image:url(<?php the_field('grid_item_3')?>); background-size: contain">
			...
			<a href="<?php the_field('grid_link_4')?>" id="grid-left-bottom-middle" class="grid-box smallsquare hoverunderline" style="background-image:url(<?php the_field('grid_item_4')?>); background-size: contain">
			...
			<a href="<?php the_field('grid_link_5')?>" id="grid-left-bottom-right" class="grid-box smallsquare hoverunderline" style="background-image:url(<?php the_field('grid_item_5')?>); background-size: contain">
