...
<div id="grid-container">
	...
	<div id="grid-journal-right" class="grid-box extra-large">
		...
		<p class="grid-journal-right-action">Have a look at our journal</p>
			...
			<a href="<?php the_field('grid_link_6')?>" id="grid-journal-left-top-left" class="grid-box smallsquare hoverunderline" style="background-image:url(<?php the_field('grid_item_6')?>); background-size: contain">
			...
			<a href="<?php the_field('grid_link_7')?>" id="grid-journal-left-top-middle" class="grid-box smallsquare hoverunderline"  style="background-image:url(<?php the_field('grid_item_7')?>); background-size: contain">
				<span id="grid-journal-ltm-description" class="grid-description"><p><?php the_field('grid_description_7')?></p></span>
				<div id="cta-grid">View product</div>
				
			</a>

		<a href="<?php the_field('grid_link_8')?>" id="grid-journal-left-bottom-left" class="grid-box smallsquare hoverunderline" style="background-image:url(<?php the_field('grid_item_8')?>); background-size: contain">
